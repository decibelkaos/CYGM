 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --no-compress --no-prefilter --bpp 4 --size 96 --font managed_components/lvgl__lvgl/scripts/built_in_font/Montserrat-Medium.ttf --range 0x2D-0x39 --format lvgl -o main/font_montserrat_120.c --lv-include lvgl.h
 ******************************************************************************/
...
#ifndef FONT_MONTSERRAT_120
#define FONT_MONTSERRAT_120 1
#endif

#if FONT_MONTSERRAT_120
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 108, .adv_w = 349, .box_w = 14, .box_h = 14, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 206, .adv_w = 541, .box_w = 41, .box_h = 90, .ofs_x = -3, .ofs_y = -10},
    {.bitmap_index = 2051, .adv_w = 1025, .box_w = 56, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 3983, .adv_w = 568, .box_w = 26, .box_h = 67, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4854, .adv_w = 882, .box_w = 51, .box_h = 68, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 6588, .adv_w = 879, .box_w = 51, .box_h = 68, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 8322, .adv_w = 1028, .box_w = 61, .box_h = 67, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 10366, .adv_w = 882, .box_w = 51, .box_h = 68, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 12100, .adv_w = 948, .box_w = 53, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 13929, .adv_w = 919, .box_w = 52, .box_h = 67, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 15671, .adv_w = 989, .box_w = 54, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 17534, .adv_w = 948, .box_w = 53, .box_h = 69, .ofs_x = 2, .ofs_y = -1}
};
...
static const int8_t kern_class_values[] =
{
    4, -8, 0, 8, -21, -15, -23, 8,
    0, -12, 0, 0, -8, 0, 116, -14,
    -15, 12, 12, -11, 0, -15, 12, 0,
    -80, -114, -80, -23, 35, 0, 0, -78,
    0, 14, -27, 0, 8, -14, -23, 0,
    -4, -4, -12, 0, 0, -8, 0, 0,
    -8, 12, 12, -4, 0, 0, 0, -22,
    0, -4, 0, 0, 0, 0, 0, 0,
    0, -6, -6, 0, -12, -14, 0, 0,
    12, 23, 32, 0, -29, -4, -14, 0,
    -4, -55, 12, -8, 0, 0, 0, 0,
    0, -6, -6, 0, -6, -15, 0, 0,
    6, 12, 12, 0, 0, 0, 0, 0,
    0, -8, 0, 0, -59, -61, -49, -23,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_montserrat_120 = {
#else
lv_font_t font_montserrat_120 = {
#endif
